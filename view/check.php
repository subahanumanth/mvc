...
<div class="good"><span class="detail"><b>Details</b></span><img src="<?php echo $list['profile_picture']; ?>" style="width:100px; height:90px; margin-left:430px; border-radius:50px;"><br><br>
