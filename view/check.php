...
<br>
<div class="post"> <img src="<?php echo $list['profile_picture']; ?>" class="photo" style="width:40px; height:40px; border-radius:50px;">
	<input type="text" name="content" class="content" placeholder="What's on your mind....">
	<input type="submit" name="post" class="click" value="Post"><span id="picture"><img src="<?php echo $list['profile_picture']; ?>" style="width:100px; height:90px; margin-left:400px; border-radius:50px;"></span> </div>
<br>
<hr class="line">
<br>
<?php
...
?>
			...
			<table id="customers">
				...
				<tr>
					...
					<td>
						<?php echo date("d-M-Y", strtotime($list['date_of_birth'])); ?>
					</td>
					<td>
						<?php echo $listDetailsOfGraduation; ?>
					</td>
					<td>
					...
					<td>
		            			<?php echo $listAreaOfInterest ?>
					</td>
			</table>
			<br> <a href="../new/<?php echo $_SESSION['id']; ?>" id="sample"><span class="up">Update</span></a>
			<?php
session_start();
